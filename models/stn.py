'''
This code is from https://github.com/JiawangBian/SC-SfMLearner-Release/blob/master/inverse_warp.py
'''
...
def inverse_warp2(img, depth, ref_depth, pose, intrinsics, padding_mode='zeros'):
    ...
    pose_mat = pose_vec2mat(pose[:,0:6])  # [B,3,4]
