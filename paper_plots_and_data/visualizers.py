...
#        plot_params['line_colours'] = kwargs.get('line_colours', ['tab:blue', 'tab:orange', 'tab:green', 'tab:red', 'tab:purple', 'tab:brown'])
    ...
    def plot_topdown(self, which_plane='xz', plot_gt=True, segment_range=None, outfile=None, title='Trajectory', **kwargs):
...
#        ax.set_title(title, fontsize=plot_params['fontsize'])
